...
*/
    ...
    public function get_products()
    {
        ...
        if (!$this->form_validation->run()) {
            ...
            if ($product_ids != null) {
                ...
                $products = fetch_product($user_id, (isset($filters)) ? $filters : null, $product_ids, $category_id, $limit, $offset, $order);
            } else {
    ...
    */
    ...
    public function get_orders()
    {
        ...
        if (!$this->form_validation->run()) {
            ...
            $order_details = fetch_orders(false, $_POST['user_id'], $multiple_status, false, $limit, $offset, $sort, $order, $download_invoice, false, false, $search, '', '', '', 1);
  ...
  */
    ...
    */
    ...
    //                 ->result_array();
    //         }
    //         $id = ($offer_data[$i]['type_id'] != '') ? $offer_data[$i]['type_id'] : '';
    //         $offer_data['offer_data'] = [];
    //         $offer_details = fetch_details('products', ['id' => $id]);
    //         // print_r($offer_data[$i1]['id']);
    //         //(!empty($offer_details)) ? $offer_details : ''
    //         $sliders[$i]['offer_images']  =  $offer_data;
    //         $i++;
    //     }
