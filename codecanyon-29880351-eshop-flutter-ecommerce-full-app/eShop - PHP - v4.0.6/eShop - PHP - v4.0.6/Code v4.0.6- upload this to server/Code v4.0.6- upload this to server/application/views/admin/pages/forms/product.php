                                                    ...
                                                    <div class="col-md-12 form-group mt-4">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            ?>
                                                                <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                                <div class="container-fluid row image-upload-section ">
                                                                    <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image" style="width: auto;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class=" total_allowed_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                ...
                                                                <input type="number" min="1" class="col-md-12 form-control" name="total_allowed_quantity" value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : ''; ?>" placeholder='Total Allowed Quantity'>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <label for="zipcodep" class="col-form-label">Deliverable Type</label>
