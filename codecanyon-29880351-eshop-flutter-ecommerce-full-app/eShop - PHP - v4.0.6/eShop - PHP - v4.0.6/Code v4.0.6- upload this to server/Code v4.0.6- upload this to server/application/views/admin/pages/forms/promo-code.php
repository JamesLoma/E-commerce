                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mt-2">
                                        ...
                                        <input type="datetime-local" class="form-control" name="start_date" id="start_date" min="<?= date('Y-m-d\TH:i') ?>" value="<?= @$fetched_details[0]['start_date'] ?>">
                                    </div>
                                    <div class="form-group col-md-6 mt-2">
                                    ...
                                    <div class="form-group col-md-6 no_of_users d-none mt-2">
