...
class Ticket_model extends CI_Model
{
    ...
    function get_ticket_list()
    {
        ...
        foreach ($cat_search_res as $row) {
            ...
            // $operate = '<a href="javascript:void(0)" class="view_ticket btn action-btn btn-success btn-xs mr-1 mb-1" data-id=' . $row['id'] . ' data-username=' . $row['username'] . ' data-date_created=' . $row['date_created'] . ' data-subject=' . $row['subject'] . ' data-status=' . $row['status'] . ' data-ticket_type="' . $row['title'] . '" title="View" data-target="#ticket_modal" data-toggle="modal" ><i class="fa fa-eye"></i></a>';
            // $operate .= ' <a href="javascript:void(0)" id="delete-ticket" data-id=' . $row['id'] . ' class="btn action-btn btn-danger mr-1 mb-1 btn-xs"><i class="fa fa-trash"></i></a>';
    ...
    function get_ticket_type_list()
    {
        ...
        foreach ($cat_search_res as $row) {
            ...
            <a href="javascript:void(0)" class="edit_btn dropdown-item" title="Edit" data-id="' . $row['id'] . '" data-url="admin/tickets/manage_ticket_types/"><i class="fa fa-pen"></i> Edit</a>
              <a href="javascript:void(0)" class="delete-ticket-type dropdown-item" data-id=' . $row['id'] . ' title="Delete" ><i class="fa fa-trash"></i> Delete</a></div>';

            // $operate = ' <a href="javascript:void(0)" class="edit_btn btn action-btn btn-success btn-xs mr-1 mb-1" title="Edit" data-id="' . $row['id'] . '" data-url="admin/tickets/manage_ticket_types/"><i class="fa fa-pen"></i></a>';
            // $operate .= '<a class="delete-ticket-type btn action-btn btn-danger btn-xs mr-1 mb-1" title="Delete" href="javascript:void(0)" data-id="' . $row['id'] . '" ><i class="fa fa-trash"></i></a>';
